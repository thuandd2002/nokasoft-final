...
<div class="login-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="default/index2.html" class="h1"><b>Customer</b>LTE</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">You are only one step a way from your new password, recover your password now.</p>
      <form action="{{route('route.customer.changePassword',['id'=>$user->id, 'remember_token'=>$user->remember_token ])}}" method="post">
        @csrf
