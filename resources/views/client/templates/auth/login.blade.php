    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="#" class="h1"><b>Login</b>Customer</a>
            </div>
            <div class="card-body">
                <form action="{{ route('route.customer.login') }}" method="POST">
                    @csrf
                ...
                @endif
                <p class="mb-1">
                    <a href="{{route('route.customer.forgot')}}">I forgot my password</a>
                </p>
                <p class="mb-0">
                    <a href="{{route('route.customer.register')}}" class="text-center">Register a new membership</a>
                </p>
            </div>
            <!-- /.card-body -->    
        </div>
